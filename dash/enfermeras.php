...
?>
 <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#">
                <button data-toggle='modal' data-target='#nueva_enfermera' class='btn btn-sm btn-success' style='margin: 0px 0px 10px;'>
                    Añadir nueva enfermera
                </button></a>
            </li>
            <li class="dropdown">
    ...
    <div class="modal fade" id="nueva_enfermera" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php  include "nueva_enfermera.php"; ?>
                </div>
                        ...
                        <?php
                            ...
                            $res = mysql_query($query,$conexion);
                                if ($row = mysql_fetch_row($res)) {
                                        ...
                                        $consulta_mysql = "SELECT id, nombre_enf, email FROM enfermera ORDER BY nombre_enf DESC ";
                                        $resultado_consulta_mysql=mysql_query($consulta_mysql,$conexion); 
                      
                                                    while($fila=mysql_fetch_array($resultado_consulta_mysql)){ 

                                                        echo"<tr>
                                                                <th>".$fila['nombre_enf']."</th>
                                                                <th>".$fila['email']."</th>  
                                                                <th>
                                                                    <a href='editar_enfermera.php?id=".$fila['id']."' title='".$fila['id']."'>
                                                                        <i class='fa fa-pencil-square-o' aria-hidden='true'></i>
                                                                    </a>
                                                                </th>
                                                                <th>
                                                                    <a href='borrar_enfermera.php?id=".$fila['id']."' >
                            ...
                            //CONDICIONAL (ELSE) PARA ENFERMERAS
                                        ...
                                        if ($row = mysql_fetch_row($rescol)) { 
                                            ...
                                            $consulta_mysql = "SELECT cliente.nombre_cli, enfermera.nombre_enf, citas_programadas.id, citas_programadas.id_cliente, citas_programadas.id_enfermera, citas_programadas.fecha, citas_programadas.hora FROM citas_programadas, cliente, enfermera, acceso WHERE acceso.id = enfermera.id AND  enfermera.email = '".$email."' ";
                                            $resultado_consulta_mysql=mysql_query($consulta_mysql,$conexion); 
                                                    ...
                                                    while($fila=mysql_fetch_array($resultado_consulta_mysql)){ 
                                                        ...
                                                        echo"<tr>
                                                                ...
                                                                <th>".$fila['hora']."</th> 
                                                                <th>
                                                                    <a href='editar_cita.php?cita=".$fila['id']."' title='".$fila['id']."' class='btn btn-sm btn-warning'>
                                                                        Añadir nota
                                                                    </a>
                                                                </th>
                                                            </tr>";
