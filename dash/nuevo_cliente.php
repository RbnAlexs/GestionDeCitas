...
<div class="row">
  <div class="col-xs-12">
    ...
    <form class="form-inline" action="crear_cliente.php" method="post" role="form">
      <fieldset>
        ...
        <div class="form-group col-xs-12">
              ...
              <input class="form-control" size="16" type="text" value=""  name="telefono" placeholder="Teléfono">
        </div>
